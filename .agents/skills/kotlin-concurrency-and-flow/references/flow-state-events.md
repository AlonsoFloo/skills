...
- [Kotlin control flow](../../../../apm_modules/chrisbanes/skills/skills/kotlin-control-flow/SKILL.md) — choosing `when`, guard conditions, exhaustiveness, smart casts, and early returns when modeling state and events.
...
- [Compose state and effects](../../../../apm_modules/chrisbanes/skills/skills/compose-state-and-effects/SKILL.md) — collecting event flows and wiring state holders to plain state-driven UI
